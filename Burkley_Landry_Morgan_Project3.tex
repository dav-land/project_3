...
\begin{equation}
 ...
 \label{eq:5}
\end{equation}
The physical meaning of parameter k in (\ref{eq:5}) is the value of carrying capacity over one, therefore the units of k are $prey^{-1}$.  The equilibrium solutions can be found
