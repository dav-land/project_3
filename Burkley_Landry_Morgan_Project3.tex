...
\quad In models accounting for migration, there is an apparent sub-cycle which shows the relationship between the migrating prey and geostationary predators. As the prey migrates away, it introduces another, longer lasting, decrease in food, thus reducing the number of predators. Later, as the prey return to their environment, the increase in food allows the predator population to return to its original levels. 
